...
# Title: Top Block
# Generated: Wed Aug  2 00:29:17 2017
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.cutoff_freq = cutoff_freq = samp_rate/2
        self.transition_width = transition_width = cutoff_freq
        self.data_rate = data_rate = 1e3

        ##################################################
        # Blocks
        ##################################################
        self._data_rate_range = Range(100, 10e3, 10, 1e3, 200)
        self._data_rate_win = RangeWidget(self._data_rate_range, self.set_data_rate, "data_rate", "counter_slider", float)
        self.top_layout.addWidget(self._data_rate_win)
        self._cutoff_freq_range = Range(10, samp_rate/2, 100, samp_rate/2, 200)
        ...
        self.low_pass_filter_0_1 = filter.fir_filter_fff(1, firdes.low_pass(
        	1, samp_rate, data_rate*2, data_rate, firdes.WIN_HAMMING, 6.76))
        ...
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_float*1, int(samp_rate/data_rate))
        ...
        # Connections
        ##################################################
        self.connect((self.analog_frequency_modulator_fc_0, 0), (self.blocks_complex_to_mag_0, 0))
        self.connect((self.analog_frequency_modulator_fc_0, 0), (self.low_pass_filter_0_0, 0))
        self.connect((self.analog_noise_source_x_0, 0), (self.blocks_threshold_ff_0, 0))
        self.connect((self.analog_quadrature_demod_cf_0, 0), (self.low_pass_filter_0_1, 0))
        self.connect((self.blocks_complex_to_mag_0, 0), (self.qtgui_freq_sink_x_0, 2))
        ...
        self.connect((self.blocks_threshold_ff_0, 0), (self.blocks_repeat_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_cutoff_freq(self.samp_rate/2)
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate)
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.samp_rate)
        self.low_pass_filter_0_1.set_taps(firdes.low_pass(1, self.samp_rate, self.data_rate*2, self.data_rate, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, self.cutoff_freq, self.transition_width, firdes.WIN_HAMMING, 6.76))
        ...
        self.blocks_repeat_0.set_interpolation(int(self.samp_rate/self.data_rate))
    ...
    def set_cutoff_freq(self, cutoff_freq):
        ...
        self.set_transition_width(self.cutoff_freq)
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, self.cutoff_freq, self.transition_width, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.cutoff_freq, self.transition_width, firdes.WIN_HAMMING, 6.76))
